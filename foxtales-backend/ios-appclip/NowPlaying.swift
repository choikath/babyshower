...
enum NowPlaying {
    ...
    static func setMetadata(title: String, artist: String) {
    ...
    static func update(elapsed: Double, duration: Double, rate: Float) {
        var info: [String: Any] = MPNowPlayingInfoCenter.default().nowPlayingInfo ?? [:]
    ...
    static func configureRemoteCommands(play: @escaping () -> Void,
                                        pause: @escaping () -> Void,
